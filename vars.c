 ...
 * @buf: char buffer
 * @p: address of curr pos in buf
 *
 * Return: 1 if chain delimiter, 0 if otherwise.
 */
 ...
 * @info: parameter struct
 * @buf: chararcter buffer
 * @p: address of curr pos in buffer
 * @i: starting position
 * @len: length of buf
 *
 * Return: Nothing.
...
/**
 * replace_alias - replaces an alias in tokenised string
 * @info: parameter struct
 *
